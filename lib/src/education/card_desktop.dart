          ...
          Expanded(
            ...
            child: Column(
              ...
              children: <Widget>[
                FittedBox(
                    fit: BoxFit.cover,
                    child: text(insttution, 25, Colors.white)),
                Padding(
                  padding: const EdgeInsets.only(bottom: 5.0),
                  child: FittedBox(
                      fit: BoxFit.cover,
                      child: text(location, 10, Colors.white)),
                ),
                FittedBox(
                    fit: BoxFit.cover,
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: 11.0),
                      child: text(years != '' ? 'Years of study: ' + years : '',
                          12, Colors.white),
                    )),
                FittedBox(
                    fit: BoxFit.cover, child: text(desc, 15, Colors.white)),
                FittedBox(
                    fit: BoxFit.cover,
                    child: text(
                        grades != '' ? 'Grades Achieved: ' + grades : '',
                        12,
                        Colors.white)),
              ],
            ),
